...
% Custom environment/command for listing publications
\newenvironment{publications}[2][noresume]{
\ifthenelse{\equal{#1}{noresume}}{
	\begin{enumerate}[label=\PubCite{#2}{white}{\arabic*}]
}{
	\begin{enumerate}[label=\PubCite{#2}{white}{\arabic*},#1]
		}
		}{\end{enumerate}}
...
\newcommand{\PublicationBase}[5][nodoi]{\textit{#2}, #3, #4, #5 \ifthenelse{\equal{#1}{nodoi}}{doi: none}{\doi{#1}}}
\newcommand{\Publication}[6][nodoi]{\PublicationBase[#1]{#2}{#3}{#4}{arXiv:\href{https://arxiv.org/abs/#5}{#5 [#6]}}}
\newcommand{\PublicationConf}[5][nodoi]{\PublicationBase[#1]{#2}{#3}{#4}{CONF:\href{https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/CONFNOTES/#5}{#5}}}
\newcommand{\PublicationPub}[5][nodoi]{\PublicationBase[#1]{#2}{#3}{#4}{PUB:\href{https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PUBNOTES/#5}{#5}}}
...
\newcommand{\PublicationInt}[5][nodoi]{\PublicationBase[#1]{#2}{#3}{#4}{INT:\href{https://atlas.web.cern.ch/Atlas/GROUPS/PHYSICS/PUBNOTES/#5}{#5}}}
