...
\newcommand{\PublicationOngoing}[4]{\PublicationBase[nodoi]{#1}{#2}{#3}{#4}}
...
\newcommand{\Presentation}[4]{\parbox{0.75\textwidth}{\textit{#1}, #2 \href{#3}{[\faIcon{external-link-alt}~link]}} \hfill \fcolorbox{black}{black!10}{#4}}

\newcommand{\InvitedTalk}[2]{#1 \hfill \fcolorbox{black}{black!10}{#2}}
