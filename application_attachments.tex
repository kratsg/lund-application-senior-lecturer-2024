...
% 	\includegraphics[width=0.95\textwidth]{attachemnts/G-outreach/scholarAtLargeNewspaper}
% \end{figure}
...
\begin{figure}[h!]
	...
	\subfloat[Postdoctober 2022, UC Santa Cruz. \href{https://web.archive.org/web/20240222115720/https://science.ucsc.edu/postdoctober-2022/}{[\faIcon{external-link-alt}~url]}]{\includegraphics[width=0.25\textwidth]{attachments/G-outreach/postdoctober2022}}\hspace{1em}
	\subfloat[Inner Voices, The Guardian. \href{https://web.archive.org/web/20211025125540/https://www.theguardian.com/science/2021/oct/25/the-last-great-mystery-of-the-mind-meet-the-people-who-have-unusual-or-non-existent-inner-voices}{[\faIcon{external-link-alt}~url]}]{\includegraphics[width=0.25\textwidth]{attachments/G-outreach/innerVoice}}\hspace{1em}
	\subfloat[Deaf scientists, Physics Today. \href{https://web.archive.org/web/20210723175238/https://physicstoday.scitation.org/do/10.1063/PT.6.4.20210723a/full/}{[\faIcon{external-link-alt}~url]}]{\includegraphics[width=0.25\textwidth]{attachments/G-outreach/deafScientists}}\\
	\subfloat[Public Likelihoods, Symmetry Magazine \href{https://web.archive.org/web/20210115133429/https://www.symmetrymagazine.org/article/atlas-releases-full-orchestra-of-analysis-instruments}{[\faIcon{external-link-alt}~url]}]{\includegraphics[width=0.25\textwidth]{attachments/G-outreach/publicLikelihoods}}\hspace{1em}
	\subfloat[Life as Deaf Particle Physicist, ASL, CERN YouTube. \href{https://www.youtube.com/watch?v=3sESUT1UO6E}{[\faIcon{external-link-alt}~url]}]{\includegraphics[width=0.25\textwidth]{attachments/G-outreach/lifeAsParticlePhysicist}}\hspace{1em}
	\subfloat[Analysis Preservation Bootcamp, IRIS-HEP. \href{https://web.archive.org/web/20200225185628/https://iris-hep.org/2020/02/17/analysis-preservation.html}{[\faIcon{external-link-alt}~url]}]{\includegraphics[width=0.25\textwidth]{attachments/G-outreach/analysisPreservationBootcamp}}\\
	\subfloat[ASL in Physics, Symmetry Magazine. \href{http://web.archive.org/web/20191205000925/https://www.symmetrymagazine.org/article/a-matter-of-interpretation-asl-physics}{[\faIcon{external-link-alt}~url]}]{\includegraphics[width=0.25\textwidth]{attachments/G-outreach/matterInterpretation}}\hspace{1em}
	\subfloat[Using CI/CD in CERN, GitLab Blog. \href{https://web.archive.org/web/20181019022114/https://about.gitlab.com/customers/cern/}{[\faIcon{external-link-alt}~url]}]{\includegraphics[width=0.25\textwidth]{attachments/G-outreach/gitlab}}\hspace{1em}
	\subfloat[LHC Experiments in ASL, CERN YouTube. \href{https://www.youtube.com/watch?v=BaGjAruqFec}{[\faIcon{external-link-alt}~url]}]{\includegraphics[width=0.25\textwidth]{attachments/G-outreach/lhcExperiments}}
...
\begin{figure}[h!]
	...
	\includegraphics[width=0.95\textwidth]{attachments/G-outreach/redCrossBoardOfDirectors}
\end{figure}
...
% 	\subfloat[front page]{\includegraphics[width=0.45\textwidth]{attachemnts/G-outreach/best-of-class_1}}\hspace{1em}
% 	\subfloat[next page]{\includegraphics[width=0.45\textwidth]{attachemnts/G-outreach/best-of-class_2}}
% \end{figure}
