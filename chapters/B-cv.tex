...
\vspace{-2.0em}\section{Education}
 {
  \footnotesize
...
\vspace{-2.0em}\section{Employment}\vspace{-1em}
\begin{table*}[h!]
	\footnotesize
	\begin{tabular}{r|lr}
		\centering
...
\vspace{-2.0em}\section{Awards and distinctions}
 {
  \footnotesize
  \begin{tabular}{r|l}
...
\vspace{-2.0em}\section{International research and teaching experience}
{
\footnotesize
...
\vspace{-2.0em}\section{Assignments as editor, referee}
 {
  \footnotesize
  JHEP (2022, 2020) {\color{red!75!black!50}\large\rmfamily\textbullet} SciPost Phys (2024 x2)
 }

\vspace{-2.0em}\section{Scholarly/academic societies}
\begin{tabular}{r|ll}
